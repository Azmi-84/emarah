    ...
    <section className='py-24 bg-white'>
        <div className='container'>
            <div className='section-heading'>
                ...
                <p className='section-description mt-5'>Always Free to Use. Upgrade for enhanced privacy, advanced features, and unlimited messaging.</p>
            </div>
                        ...
                        <div className='flex justify-between'>
                            ...
                            {popular === true && (
                                <div className='inline-flex text-sm px-4 py-1.5 rounded-xl border border-white/20'>
                                    <motion.span className='bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF)] [background-size:200%] text-transparent bg-clip-text font-medium'
                                    animate={{
