...
const Footer = () => {
  ...
  const imageItems = [
    ...
    { src: socialYoutube, alt: 'Social Youtube', label: 'Social Youtube', href: '' },
    { src: socialInsta, alt: 'Social Instagram', label: 'Social Instragram', href: '' },
    { src: socialDiscord, alt: 'Social Discord', label: 'Social Discord', href: '' },
    { src: socialPin, alt: 'Social Pinterest', label: 'Social Pinterest', href: '' },
  ]
